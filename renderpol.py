from rl.utils import renderpolicy, rendermultipolicy, renderpolicy_speedinput
from cassie import CassieEnv, CassieEnv_rand_dyn
...
cassie_env = CassieEnv_rand_dyn("walking", clock_based=True, state_est=True)
...
policy = torch.load("../cassie-RL-policies/standing/stepping2standing/original_walking.pt")
policy.eval()
